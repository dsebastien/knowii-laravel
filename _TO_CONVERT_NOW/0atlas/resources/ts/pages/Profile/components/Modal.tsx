...
function Modal(props: Props) {
  return (
    <div>
      {props.show && (
        <div onClick={() => props.setShow(false)} className="fixed inset-0 flex justify-center bg-gray-900 bg-opacity-50">
          <div
          ...
          >
            ...
            <div>
              <div className="w-full pl-4 md:pl-0">{props.children}</div>
            </div>
          </div>
        </div>
      )}
